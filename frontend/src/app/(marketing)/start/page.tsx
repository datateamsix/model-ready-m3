...
import { projectsSource } from "@/lib/adapters/api-projects-source";
 ...
 * resolution against the real BillingSource + ProjectsSource: both fail
 ...
 * CreateProjectForm submit does that.
 */
...
function EntitledCardBody({
  ...
  return (
    <>
      ...
      {state.canCreate ? (
        <CreateProjectForm stage={stage} label={createLabel} />
      ) : (
        state.projects.length > 0 && (
