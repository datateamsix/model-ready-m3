...
vi.mock("@/lib/adapters/api-project-source", () => ({
  projectSource: { listProjects: () => mockListProjects(), createProject: vi.fn() },
}));
...
vi.mock("@/components/prem3/start-create-project-form", () => ({
  StartCreateProjectForm: ({ stage, label }: { stage: string; label: string }) => (
